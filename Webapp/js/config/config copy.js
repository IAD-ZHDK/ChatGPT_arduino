...
const config = {
  ...
  conversationProtocol: [
    {
      role: "system",
      content: `You control an external device with several functions calls. Try connecting again if there is any trouble with the functions. You will also sometimes receive notifications from events ${JSON.stringify(notifications )}.`,
    },
